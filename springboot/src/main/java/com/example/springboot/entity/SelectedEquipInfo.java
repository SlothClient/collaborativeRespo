...
public class SelectedEquipInfo {
    ...
    public SelectedEquipInfo(String equipName,String equipPic, String equipId, Date lastMaintance, String maintanceDesc, String orderDesc, String orderRecord) {
    ...
    public String getEquipPic() {return equipPic;}

    public void setEquipPic(String equipPic) {this.equipPic = equipPic;}
