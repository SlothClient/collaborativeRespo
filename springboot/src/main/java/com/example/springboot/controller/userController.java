...
public class userController {
    ...
    public Result updateUserInfoList(@RequestBody UserInfoResp userInfoResp) {
        System.out.println(userInfoResp);
        return userInfoService.updateUserInfoList(userInfoResp);
    }
    @ResponseBody
    @PostMapping("/addUserInfoList")
    public Result addUserInfoList(@RequestBody UserInfoResp userInfoResp) {
        System.out.println(userInfoResp);
        return userInfoService.addUserInfoList(userInfoResp);
    }

    @ResponseBody
    @PostMapping("/deleteUserInfo")
    public Result deleteUserInfo(@RequestBody UserInfoResp userInfoResp) {
        System.out.println(userInfoResp);
        return userInfoService.deleteUserInfo(userInfoResp);
    }
