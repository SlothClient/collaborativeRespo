/*
 ...
 Source Schema         : maintenance_db

 Target Server Type    : MySQL
 Target Server Version : 80036 (8.0.36)
 File Encoding         : 65001

 Date: 07/10/2024 22:33:54
*/
...
CREATE TABLE `approval_info`  (
  `approval_id` varchar(30) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL,
  `plan_id` varchar(30) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL,
  `father_id` varchar(30) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  `applicant_id` varchar(30) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  `manip_time` datetime NULL DEFAULT NULL,
  `approval_status` tinyint NULL DEFAULT NULL,
  `step_order` tinyint NULL DEFAULT NULL,
  `approval_remark` text CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL,
  `is_deleted` int NULL DEFAULT 0,
  PRIMARY KEY (`approval_id`) USING BTREE,
  INDEX `pid_fk`(`plan_id` ASC) USING BTREE,
  INDEX `aid_fk`(`father_id` ASC) USING BTREE,
  INDEX `applicantId_fk`(`applicant_id` ASC) USING BTREE,
...
CREATE TABLE `check_info`  (
  `check_id` varchar(30) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL,
  `equip_id` varchar(30) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  `check_time` datetime NULL DEFAULT NULL,
  `worker_id` varchar(30) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  `check_desc` text CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL,
  `check_out` text CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL,
...
CREATE TABLE `checkitem_info`  (
  `checkitem_id` varchar(30) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL,
  `checkitem_name` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  `check_id` varchar(30) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  `checkitem_time` datetime NULL DEFAULT NULL,
  `checkitem_out` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
...
CREATE TABLE `equip_info`  (
  `equip_id` varchar(30) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL,
  `equip_name` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  `equip_pic` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  `equip_status` tinyint NULL DEFAULT NULL,
  `valid_time` tinyint NULL DEFAULT NULL,
  `purchase_date` datetime NULL DEFAULT NULL,
  `fix_big` tinyint NULL DEFAULT NULL,
  `fix_medium` tinyint NULL DEFAULT NULL,
  `fix_small` tinyint NULL DEFAULT NULL,
  `count_big` tinyint NULL DEFAULT NULL,
  `count_medium` tinyint NULL DEFAULT NULL,
  `count_small` tinyint NULL DEFAULT NULL,
  `last_maintance` datetime NULL DEFAULT NULL,
...
CREATE TABLE `maintance_info`  (
  `plan_id` varchar(30) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL,
  `equip_id` varchar(30) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  `plan_name` varchar(30) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  `start_time` datetime NULL DEFAULT NULL,
  `end_time` datetime NULL DEFAULT NULL,
  `status` tinyint NULL DEFAULT NULL,
  `maintance_desc` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  `maintance_type` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  `is_deleted` int NULL DEFAULT 0,
  PRIMARY KEY (`plan_id`) USING BTREE,
  INDEX `eid_fk`(`equip_id` ASC) USING BTREE,
...
CREATE TABLE `maintance_type`  (
  ...
  `maintance_name` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
...
CREATE TABLE `menu_info`  (
  `menu_id` varchar(30) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL,
  `menu_name` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  `parent_id` varchar(30) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  ...
  `menu_order` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
...
INSERT INTO `menu_info` VALUES ('M006', '工单计划', 'M005', 'WorkOrder', 'Document', 'workorder:manage_plan', '5');
INSERT INTO `menu_info` VALUES ('M007', '工时管理', 'M005', 'WorkHours', 'Clock', 'workhours:manage', '5');
...
CREATE TABLE `order_info`  (
  `order_id` varchar(30) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL,
  `equip_id` varchar(30) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL,
  `plan_id` varchar(30) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  `start_time` datetime NULL DEFAULT NULL,
  `end_time` datetime NULL DEFAULT NULL,
  `worker_id` varchar(30) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  `order_desc` text CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL,
  `order_record` text CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL,
  PRIMARY KEY (`order_id`) USING BTREE,
  INDEX `pid_fk_2`(`plan_id` ASC) USING BTREE,
  INDEX `eid_fk_2`(`equip_id` ASC) USING BTREE,
  INDEX `wid_fk_1`(`worker_id` ASC) USING BTREE,
...
-- ----------------------------
INSERT INTO `order_info` VALUES ('1843281858862428161', 'EQ005', '1839912235471466497', '2024-10-07 21:26:56', NULL, 'W002', 'haha', NULL);
INSERT INTO `order_info` VALUES ('1843282125955706882', 'EQ003', '1840587262277664769', '2024-10-07 21:28:00', NULL, 'W001', 'lallala', NULL);
INSERT INTO `order_info` VALUES ('1843282126102507521', 'EQ009', '1840754307044646914', '2024-10-07 21:28:00', NULL, 'W001', 'aaaaa', NULL);
INSERT INTO `order_info` VALUES ('1843282534812266498', 'EQ005', '1839912235471466497', '2024-10-07 21:29:37', NULL, 'W002', 'haha', NULL);
INSERT INTO `order_info` VALUES ('1843284296696770561', 'EQ001', '1840350924613828610', '2024-10-07 21:36:37', NULL, 'W001', '测试', NULL);
INSERT INTO `order_info` VALUES ('1843284296772268034', 'EQ001', '1840580697608937474', '2024-10-07 21:36:37', NULL, 'W001', '测试', NULL);
INSERT INTO `order_info` VALUES ('1843284296826793986', 'EQ002', '1840585257048031233', '2024-10-07 21:36:37', NULL, 'W001', '测试', NULL);
INSERT INTO `order_info` VALUES ('1843289172399083521', 'EQ002', '1843287985004204034', '2024-10-07 21:55:59', NULL, 'W002', '测试派单', NULL);
...
CREATE TABLE `role_info`  (
  `role_id` varchar(30) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL,
...
CREATE TABLE `role_menu`  (
  `rm_id` varchar(30) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL,
  `role_id` varchar(30) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  `menu_id` varchar(30) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  PRIMARY KEY (`rm_id`) USING BTREE,
  INDEX `rid_fk_1`(`role_id` ASC) USING BTREE,
  INDEX `mid_fk_1`(`menu_id` ASC) USING BTREE,
...
CREATE TABLE `user_info`  (
  `user_id` varchar(30) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL,
...
CREATE TABLE `user_role`  (
  `ur_id` varchar(30) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL,
  `user_id` varchar(30) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  `role_id` varchar(30) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  PRIMARY KEY (`ur_id`) USING BTREE,
  INDEX `uid_fk_1`(`user_id` ASC) USING BTREE,
  INDEX `rid_fk_2`(`role_id` ASC) USING BTREE,
...
CREATE TABLE `worker_info`  (
  `worker_id` varchar(30) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL,
  `worker_name` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  `dept` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
...
INSERT INTO `worker_info` VALUES ('W002', '李四', '工程部', 30.00);
