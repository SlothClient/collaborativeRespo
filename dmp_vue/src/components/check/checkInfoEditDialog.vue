...
const confirmEdit = () => {
  ...
  // 简化的空值校验逻辑
  const fieldsToCheck = ['checkName', 'equipId', 'checkDesc', 'checkSite','checkContent', 'startTime'];
  ...
  // 如果没有空值，继续进行后续逻辑
  emit("editCheckInfo", editPlan.value);
  closeDialog(); // 关闭对话框
};
