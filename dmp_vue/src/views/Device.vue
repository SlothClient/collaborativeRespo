        ...
        <el-row class="row-bg" justify="space-evenly" style="margin-top: 15px;">
          ...
          <el-col :span="7"><div class="grid-content ep-bg-purple-light" >
            <el-form-item prop="status" label="状态"style="display: flex">
              <el-input v-model="form.status" autocomplete="off" placeholder="请输入状态" style="width: 150px;display: flex;margin-right: 10px;"/>
            </el-form-item>
          </div>
          </el-col>
          <el-col :span="7"><div class="grid-content ep-bg-purple" >
...
<!--        </el-row>-->
        ...
        <el-row class="row-bg" justify="space-evenly" style="margin-top: 15px;">
          ...
          <el-col :span="7"><div class="grid-content ep-bg-purple" >
            <el-form-item prop="lastMaintance" label="最后保养日期">
              <el-date-picker
